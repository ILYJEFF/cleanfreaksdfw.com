        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1.15fr] lg:items-end">
          <div>
            ...
            <p className="mt-4 text-lg text-ink-mute text-pretty">
              We keep commercial schedules and Airbnb turnovers tight across the northern DFW corridor.
            </p>
            <div className="mt-8 inline-flex items-start gap-3 border-2 border-ink bg-paper px-4 py-3 text-sm font-medium text-ink shadow-punch">
              ...
              <span>
                Home base: <strong className="font-extrabold">{CONTACT.city}</strong>
              </span>
            </div>
          </div>
          ...
          <ul className="grid grid-cols-2 gap-3 sm:grid-cols-3">
            {SERVICE_CITIES.map((city) => (
              <li
                key={city}
                className="border-2 border-ink bg-paper px-4 py-3.5 text-sm font-extrabold text-ink transition-all hover:-translate-y-0.5 hover:bg-lime hover:shadow-punch"
              >
                {city}
              </li>
            ))}
